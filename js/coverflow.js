! function(a, b) {
    var c = {},
        d = a.coverflow = function(a) {
            if (!a)
                for (var b in c) a = c[b].id;
            if (a) {
                var d = c[a];
    ...
    "undefined" != typeof jQuery && (jQuery.fn.coverflow = function(a) {
        var b = d(this[0].id);
        return b[a] ? b[a].apply(b, Array.prototype.slice.call(arguments, 1)) : "object" == typeof a ? b.setup.apply(b, arguments) : a ? ($.error("Method " + a + " does not exist on jQuery.coverflow"), void 0) : b
    });
    var e = 0,
        f = {
            ...
            on: function(a, b, c) {
                if (a)
                    for (var d = b.split(" "), e = 0; e < d.length; e++) a.attachEvent ? a.attachEvent("on" + d[e], c) : a.addEventListener(d[e], c, !1)
            },
            off: function(a, b, c) {
                if (a)
                    for (var d = b.split(" "), e = 0; e < d.length; e++) a.detachEvent ? a.detachEvent("on" + d[e], c) : a.removeEventListener(d[e], c, !1)
            },
            extend: function(a, b) {
            ...
            jsonp: function(c, d, e) {
                ...
                j.src = -1 !== c.indexOf("callback=?") ? c.replace("callback=?", "callback=" + i) + g.slice(0, -1) : c + g + "callback=" + i, j.async = !0, j.onload = j.onreadystatechange = function() {
        ...
        g = function(d) {
            ...
            this.id = d, this.el = b.getElementById(d), this.config = null, this.setup = function(c) {
                ...
                var i = {
                    ...
                    reflectionoffset: 0,
                    showtext: !0,
                    textstyle: ".coverflow-text{color:#f1f1f1;text-align:center;} .coverflow-text h1{font-size:14px;font-weight:normal;line-height:21px;} .coverflow-text h2{font-size:11px;font-weight:normal;} .coverflow-text a{color:#0000EE;}",
                    textoffset: 75,
                    tweentime: .8,
                    rotatedelay: 0,
                    focallength: 250,
    ...
    h.prototype.handleEvent = function(a) {
        ...
        if (b.stopImmediatePropagation(), b.preventDefault(), a.removeEventListener("touchmove", this, !0), a.removeEventListener("touchend", this, !0), this.elem.style[this.transformProp] = this.config.tweentime + "s", this.moved) {
            var c = this.currentX - this.lastX,
                d = (new Date).getTime() - this.lastMoveTime + 1;
    ...
    j.prototype.updateTouchEnd = function(a) {
        ...
        if ("coverflow-hit" == a.target.className) {
            var c = this.getFocusedCover(b),
                d = this.hits[f.getChildIndex(a.target)];
    ...
    var m = function(a) {
        ...
        function e(a) {
            ...
            var b = a.detail ? -120 * a.detail : a.wheelDelta,
                c = Math.ceil(Math.abs(b) / 120);
            if (c > 0) {
                var d = Math.abs(b) / b,
                    e = null;
                if (d > 0 ? e = p.left : 0 > d && (e = p.right), "function" == typeof e)
                    for (var f = 0; c > f; f++) e()
            }
        }
        ...
        function h(b) {
            r.rotatedelay > 0 && o && p.stopRotation(), a.trigger("click", b, k[b] ? k[b].link : void 0)
        }
        ...
        this.stopRotation = function() {
            q.removeEventListener("touchstart", p.stopRotation, !1), q.removeEventListener("mousedown", p.stopRotation, !1), clearInterval(o)
        }, this.resize = function(a, b) {
    ...
    var n = function(a) {
        ...
        o = function() {
            ...
            this.on = function(b) {
                ...
                if (b)
                    for (var c = 0; c < a.length; c++) a[c] === b && (a.splice(c, 1), c--);
                else a = [];
                return this
            }
        }
