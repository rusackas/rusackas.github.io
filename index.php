...
-->
      ...
      <section class="module content" id="section_future" data-title="Onward...">
        <div class="container">
          ...
          <p>
            I'm continually enamored with all the possibilities of CSS3 and HTML5 paired with <a href="http://jquery.com/">jQuery</a>, as you may have noticed. Its quickly growing support in evergreen browsers is allowing for rapid progress in the design and development of user interfaces, and a TON of icing on top. My new favorite front-end IDE, <a href="http://brackets.io/?lang=en">Brackets</a>, along with my favorite watchdog <a href="">CodeKit</a> adding in <a href="http://bower.io/"></a>Bower and <a href="http://sass-lang.com/">SASS</a> and minification support, are making it fun and easy to implement these techniques. It's exciting to see vendor previxing slip behind the curtain, and disappearing, while the moving parts neede to build sites become more plug-and-play.</p>
